...
<div class="breadcrumb-wrapper">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">كل الاشعارات </a>
        </li>
    </ol>
</div>
...
{{-- <a class="btn btn-primary" data-toggle="modal" href="#inlineForm" style="margin-bottom:1%">{{ trans('main_trans.add') }}</a>  --}}
            ...
            <?php $noti_teacher2 = \App\Models\NotificationTeacher::where('teacher_id',Auth::guard('teachers')->user()->id)->orderBy('id','desc')->paginate(10);?>
            @foreach($noti_teacher2 as $not)
            ...
            <div style="padding:1%">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <p><span class="font-weight-bolder">{{ $not->title }} <br> <span style="color:black;font-weight: 100">{{$not->description }}</span> </small> <br>
                    </div>
                </div>
            </div>
