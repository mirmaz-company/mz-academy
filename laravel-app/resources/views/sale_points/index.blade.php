...
<div class="breadcrumb-wrapper">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">نقاط البيع </a>
        </li>
    </ol>
</div>
                ...
                <form id="add_user_form">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <input type="hidden" name="city_id" value="{{ $id }}" id="city_id">
                            ...
                            <div class="col-md-12">
                                <label>الوصف  </label>
                                <div class="form-group">
                                    <textarea name="descriptions" id="descriptions" class="form-control" cols="10" rows="10"></textarea>
                ...
                <form id="edit_user_form">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <input type="hidden" name="city_id" value="{{ $id }}" id="city_id2">
                            <div class="col-md-12">
                                <label>اسم  </label>
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <label>الوصف  </label>
                                <div class="form-group">
                                    <textarea name="descriptions" id="descriptions2" class="form-control" cols="10" rows="10"></textarea>
    ...
    <script>
     ...
     <script type="text/javascript">
        ...
        var table = $('.yajra-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('get_all_sale_points',$id) }}",
            columns: [
