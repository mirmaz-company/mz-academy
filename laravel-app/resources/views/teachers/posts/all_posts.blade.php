...
<div class="breadcrumb-wrapper">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">منشوراتي </a>
        </li>
    </ol>
</div>
...
<a class="btn btn-primary" href="{{ route('teachers.posts') }}" style="margin-bottom:1%">اضافة منشور</a> 
    ...
    <script>
     ...
     <script type="text/javascript">
        ...
        var table = $('.yajra-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('teachers.get_all_posts') }}",
            columns: [
...
<script>
   ...
   <script>
        function do_delete(){
            ...
            $.ajax({
                type: 'post',
                url: "{{route('teachers.destroy_posts')}}",
                data: formData,
                processData: false,
                contentType: false,
                success: function (data) {
