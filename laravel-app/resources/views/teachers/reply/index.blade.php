...
<div class="breadcrumb-wrapper">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">الردود </a>
        </li>
    </ol>
</div>
...
<?php $comment = \App\Models\Comment::where('id',$id)->first(); ?>
<h1>التعليق :{{ $comment ->comment }}</h1> <br>
                ...
                <form id="add_user_form">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <label>اضافة رد  </label>
                                <div class="form-group">
                                    <input type="text" name="reply" id="reply"  class="form-control" />
                                    <span id="reply_error" class="text-danger"></span>
                                </div>
                            </div>
    ...
    <script>
     ...
     <script type="text/javascript">
        ...
        var table = $('.yajra-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('teachers.get_all_reply',$id) }}",
            columns: [
...
<script>
        ...
        $(document).on('click', '#add_user', function (e) {
            ...
            var formData = new FormData($('#add_user_form')[0]);
                $.ajax({
                    ...
                    url: "{{route('teachers.store_reply')}}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    cache: false,
   ...
   <script>
        function do_delete(){
            ...
            $.ajax({
                type: 'post',
                url: "{{route('teachers.destroy_reply')}}",
                data: formData,
                processData: false,
                contentType: false,
                success: function (data) {
