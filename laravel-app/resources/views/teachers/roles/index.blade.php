...
<div class="breadcrumb-wrapper">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">الادوار</a>
        </li>
    </ol>

     {{-- @can('اضافة صلاحية') --}}
     {{-- لازم الاستاذ بس يضيف الصلاحيات عشان اعرف اعرض بس الصلاحيات الخاصة بالاستاذ --}}
  
     <a class="btn btn-primary btn-sm" href="{{ route('teachers.roles.create') }}">اضافة</a>
