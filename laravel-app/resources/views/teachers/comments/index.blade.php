                ...
                <table class="datatables-basic table table-responsive-md yajra-datatable">
                    <thead>
                        <tr>
                            ...
                            <th>#</th>
                           <th style="width:100px">الصورة الشخصية</th>
                            <th>الاسم</th>
                            <th>التعليق</th>
                            <th>الردود</th>
                            <th>التاريخ</th>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <input type="name" name="comment" id="comment"  class="form-control" />
    ...
    <script>
     ...
     <script type="text/javascript">
        ...
        var table = $('.yajra-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('teachers.get_all_comments',$id) }}",
            columns: [
...
<script>
        ...
        $(document).on('click', '#add_user', function (e) {
            ...
            var formData = new FormData($('#add_user_form')[0]);
                $.ajax({
                    ...
                    url: "{{route('teachers.store_comments')}}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    cache: false,
   ...
   <script>
        function do_delete(){
            ...
            $.ajax({
                type: 'post',
                url: "{{route('teachers.destroy_comments')}}",
                data: formData,
                processData: false,
                contentType: false,
                success: function (data) {
