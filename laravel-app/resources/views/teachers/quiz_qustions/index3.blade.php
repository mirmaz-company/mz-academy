                ...
                <div class="modal-body">
                    <form  id="add_user_form" class="invoice-repeater">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <label>   <span style="font-size: 13px;">( الاسئلة)</span></label>
                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div>
                                                <div class="form-group">
                                                    <textarea name="qustion" placeholder=" السؤال"  id="qustion" class="form-control" cols="4" rows="2"></textarea>
                                                </div>
                                            </div>
