        ...
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel33">اضافة سؤال </h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label> السؤال </label>
                                    <textarea name="qustion" name="qustion" id="" class="form-control" cols="4" rows="2"></textarea>
                                </div>
                            </div>
                            <div class="col-md-4">
                                    ...
                                    <div class="media mb-2">
                                        <img src="{{ asset('upload.png') }}" alt="users avatar" id="image3" class="user-avatar3 users-avatar-shadow rounded mr-2 my-25 cursor-pointer" height="90" width="90" /> 
                                        <div class="media-body mt-50">
                                            <div class="col-12 d-flex mt-1 px-0">
                                                <label class="btn btn-primary mr-75 mb-0" for="change-picture3">
                                                    <span class="d-none d-sm-block">  اختر صورة  </span>
                                                        <input class="form-control" type="file" multiple id="change-picture3" name="image45" hidden required accept="image/png, image/jpeg, image/jpg" />
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label> الاجابة الصحيحة  <span style="font-size: 13px;">(ضع الاجابة الصحيحة هنا)</span></label>
                                    <textarea name="answer_true" placeholder="الاجابة الصحيحة"  id="answer_true" class="form-control" cols="4" rows="2"></textarea>
                                </div>
                            </div> 
                                    ...
                                    <div class="media-body mt-50">
                                        <div class="col-12 d-flex mt-1 px-0">
                                            <label class="btn btn-primary mr-75 mb-0" for="change-picture">
                                                <span class="d-none d-sm-block">  اختر صورة  </span>
                                                    <input class="form-control" type="file" multiple id="change-picture" name="imag334e" hidden required accept="image/png, image/jpeg, image/jpg" />
                                                    <span class="d-block d-sm-none">
                                                    <i class="mr-0" data-feather="edit"></i>
                                                </span>
                                            </label>
                            ...
                            <div class="col-md-12">
                                <label> باقي الاجابات <span style="font-size: 13px;">(الخيارات الخاطئة)</span></label>
                            </div>
                                ...
                                <div data-repeater-item>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div>
                                                <div class="form-group">
                                                    <textarea name="answer_false" placeholder="الاجابة الخاطئة"  id="answer_false" class="form-control" cols="4" rows="2"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="media-body mt-50">
                                                <div class="col-12 d-flex mt-1 px-0">
                                                    <label class="btn btn-primary mr-75 mb-0" >
                                                        <span class="d-none d-sm-block">اختر صورة</span>
                                                            <input class="form-control" type="file"  name="image_answers" onchange="uploadImage(this);" hidden required accept="image/png, image/jpeg, image/jpg" />
                                                            <span class="d-block d-sm-none">
                                                            <i class="mr-0" data-feather="edit"></i>
                                                        </span>
                                                    </label>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12"> 
                                ...
                                <label>السؤال </label>
                                <div class="form-group">
                                    <input type="text" name="qustion" id="qustion2" class="form-control" />
                                    <span id="qustion2_error" class="text-danger"></span>
                                </div>
                            </div>
                            <div class="media mb-2">
                                <img src="{{ asset('upload.png') }}" alt="users avatar" id="image2" class="user-avatar2 users-avatar-shadow rounded mr-2 my-25 cursor-pointer" height="90" width="90" /> 
