...
@section('content')
 ...
 <button class="btn btn-outline-primary" style="display: none" onclick="statuss()" id="position-top-status"></button> 
...
<div class="breadcrumb-wrapper">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">ماذا قالو عن التطبيق </a>
        </li>
    </ol>
</div>
    ...
    <script>
     ...
     <script type="text/javascript">
        ...
        var table = $('.yajra-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('get_all_student_are_saying') }}",
            columns: [
  ...
  <script>
    ...
    $(document).on('change','#cousome_switch', function (e) {
            ...
            $.ajax({
                type: "post",
                dataType: "json",
                url: '{{ route('change_status_student_are_saying') }}',
  ...
  <script>
    ...
    $(document).on('change','#cousome_switch2', function (e) {
            ...
            $.ajax({
                type: "post",
                dataType: "json",
                url: '{{ route('change_status_student_are_saying_forms') }}',
...
<script>
    ...
    <script>
        $('#edit_user').on('show.bs.modal', function(event) {
            ...
            modal.find('.modal-body #stars').val(stars);
        ...
        function do_update(){
            ...
            var formData = new FormData($('#edit_user_form')[0]);
                $.ajax({
                    type: 'post',
                    enctype: 'multipart/form-data',
                    url: "{{route('update_student_are_saying')}}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    cache: false,
