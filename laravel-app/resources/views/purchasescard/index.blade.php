...
<div class="breadcrumb-wrapper">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">البطاقات </a>
        </li>
    </ol>
</div>
            ...
            <div class="modal-content">
                ...
                <form id="edit_user_form2">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12"> 
                                ...
                                <label>السعر </label>
                                <div class="form-group">
                                    <input type="text" name="price" id="price3" class="form-control" />
                                    <span id="price3_error" class="text-danger"></span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                             ...
                             <div class="media mb-2">
                                 ...
                                 <div class="media-body mt-50">
                                     <div class="col-12 d-flex mt-1 px-0">
                                         <label class="btn btn-primary mr-75 mb-0" for="change-picture3">
                                             <span class="d-none d-sm-block">Change</span>
                                                 <input class="form-control" type="file" multiple id="change-picture3" name="image" hidden required accept="image/png, image/jpeg, image/jpg" />
                                                 <span class="d-block d-sm-none">
                                                 <i class="mr-0" data-feather="edit"></i>
                                             </span>
                                         </label>
                                 ...
                                 <span id="image3_error" class="text-danger"></span>
                             </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" id="editing3" onclick="do_update2()" class="btn btn-primary btn-block">حفظ التعديلات</button>
                    </div>
                </form>
            </div>
        </div>
...
@section('js')
    ...
    <script>
     ...
     <script type="text/javascript">
        ...
        var table = $('.yajra-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('get_all_purchasescard') }}",
            columns: [
    ...
    <script type="text/javascript">
        ...
        var table = $('.yajra-datatable2').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('get_all_purchasescard_price') }}",
            columns: [
                {data: 'DT_RowIndex',  name: 'DT_RowIndex', orderable: false, searchable: false},
...
<script>
        ...
        $(document).on('click', '#add_user', function (e) {
            ...
            var formData = new FormData($('#add_user_form')[0]);
                $.ajax({
                    ...
                    url: "{{route('store_purchasescard_price')}}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    cache: false,
    ...
    <script>
        $('#edit_user2').on('show.bs.modal', function(event) {
            ...
            var modal = $(this)
            modal.find('.modal-body #id2').val(id);
            modal.find('.modal-body #price3').val(price);
          
            $(".modal-body #image3").attr('src', image);
        ...
        function do_update(){
            ...
            var formData = new FormData($('#edit_user_form')[0]);
                $.ajax({
                    type: 'post',
                    enctype: 'multipart/form-data',
                    url: "{{route('update_purchasescard')}}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    cache: false,
        ...
        function do_update2(){
            ...
            var formData = new FormData($('#edit_user_form2')[0]);
                $.ajax({
                    type: 'post',
                    enctype: 'multipart/form-data',
                    url: "{{route('update_purchasescard_price')}}",
                    data: formData,
                    processData: false,
                    contentType: false,
                    cache: false,
   ...
   <script>
        function do_delete(){
            ...
            $.ajax({
                type: 'post',
                url: "{{route('destroy_purchasescard_price')}}",
                data: formData,
                processData: false,
                contentType: false,
                success: function (data) {
