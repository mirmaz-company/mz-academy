...
<div class="breadcrumb-wrapper">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">النسبة </a>
        </li>
    </ol>
</div>
        ...
        <div class="card text-center">
            <div class="card-body" style="background: white;border-radius: 6%">
                 <?php    
                    ...
                    $teacher_code_section_id = \App\Models\TeacherCodeSection::where('teacher_id',$id)->pluck('id');
        ...
        <div class="card text-center">
            <div class="card-body" style="background: white;border-radius: 6%">
                 <?php    
                     ...
                     $teacher_code_section_id2 = \App\Models\TeacherCodeSection::where('teacher_id',$id)->pluck('id');
                     $teacher_code2 = \App\Models\TeacherCode::WhereIn('section_code',$teacher_code_section_id2)->where('course_id',"!=",0)->where('user_id','!=',0)->count();
    ...
    <script>
     ...
     <script type="text/javascript">
        ...
        var table = $('.yajra-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('get_all_ratio_teachers',$id) }}",
            columns: [
                {data: 'DT_RowIndex',  name: 'DT_RowIndex', orderable: false, searchable: false},
                {data: 'name'         ,name: 'name'},
                {data: 'name_teacher'         ,name: 'name_teacher'},
              
                {data: 'price_course'         ,name: 'price_course'},
                {data: 'subsriper'         ,name: 'subsriper'},
                // {data: 'ratio'         ,name: 'ratio'},
                // {data: 'ratio_academy'         ,name: 'ratio_academy'},
