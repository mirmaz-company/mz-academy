...
<div class="breadcrumb-wrapper">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">VPN </a>
        </li>
    </ol>
</div>
                ...
                <table class="datatables-basic table table-responsive-md yajra-datatable">
                    <thead>
                        <tr>
                            ...
                            <th>ID</th>
                            {{-- <th>اسم المستخدم</th> --}}
                            <th>استخدام ال vpn</th>
                            <th>االتتبع</th>
                            <th style="width:300px">الدولة</th>
                            {{-- <th>العمليات</th> --}}
    ...
    <script>
     ...
     <script type="text/javascript">
        ...
        var table = $('.yajra-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('get_all_vpn_check') }}",
            columns: [
                {data: 'DT_RowIndex',  name: 'DT_RowIndex', orderable: false, searchable: false},
                {data: 'user_id'         ,name: 'user_id'},
                // {data: 'name'            ,name: 'name'},
                {data: 'is_vpn'         ,name: 'is_vpn'},
                {data: 'trace'           ,name: 'trace'},
