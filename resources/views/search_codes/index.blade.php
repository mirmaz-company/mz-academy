...
<div class="breadcrumb-wrapper">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">البحث في الاكواد  </a>
        </li>
    </ol>
</div>
<br><br>
<h1>البحث في اكواد الدورات الخاصة</h1>
...
<h1>البحث في اكواد الدورات المدفوع عام</h1>
...
<form id="add_user_form2">
    ...
    <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="modal-footer">
                <button type="button" style="display: none" id="add_user23" class="btn btn-primary btn-block">جاري البحث  ...</button>
                <button type="button" id="add_user3" class="btn btn-primary btn-block">بحث</button>
            </div>
        </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <label>السعر  </label>
                                <div class="form-group">
                                    <input type="number" name="price" id="price2"  class="form-control" />
    ...
    <script>
     ...
     <script type="text/javascript">
        $(document).on('click', '#add_user', function (e) {
            ...
            var code = $('#code').val(); // Get the value from the input field
            ...
            var table = $('.yajra-datatable').DataTable({
                ...
                destroy: true,
                ajax: "{{ route('get_all_search_codes', ['code' => '']) }}/" + code, // Pass the code value to the route as the 'id' parameter
                columns: [
