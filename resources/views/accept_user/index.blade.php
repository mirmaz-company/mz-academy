...
@section('content')
 ...
 <button class="btn btn-outline-primary" style="display: none" onclick="mddd()" id="position-top-33"></button> 
    ...
    <script>
        ...
        function mddd(){
            ...
            Swal.fire({
                position: 'top-start',
                icon: 'error',
                title: 'تم قبول الوثائق من قبل أدمن اخر',
                showConfirmButton: false,
                timer: 1500,
                customClass: {
                confirmButton: 'btn btn-primary'
     ...
     <script type="text/javascript">
        ...
        var table = $('.yajra-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('get_all_accept_user') }}",
            columns: [
                {data: 'DT_RowIndex',  name: 'DT_RowIndex', orderable: false, searchable: false},
                {data: 'user_id'         ,name: 'user_id'},
                {data: 'full_name'         ,name: 'full_name'},
                // {data: 'personal_photo'    ,name: 'personal_photo'},
                {data: 'code'         ,name: 'code'},
...
<script>
   ...
   <script>
    ...
    <script>
        ...
        const intervalId = setInterval(doSomething, 10000);
    </script>
