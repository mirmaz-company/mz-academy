...
<div class="breadcrumb-wrapper">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">مشاهدات السلايدر </a>
        </li>
    </ol>
</div>
    ...
    <script>
     ...
     <script type="text/javascript">
        ...
        var table = $('.yajra-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('get_all_slider_views',$id) }}",
            columns: [
...
<script>
   ...
   <script>
        function do_delete(){
            ...
            $.ajax({
                type: 'post',
                url: "{{route('destroy_slider_views')}}",
                data: formData,
                processData: false,
                contentType: false,
                success: function (data) {
