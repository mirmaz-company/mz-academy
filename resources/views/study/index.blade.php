...
<div class="breadcrumb-wrapper">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">الدراسة </a>
        </li>
    </ol>
</div>
...
{{-- <form action="{{ url('upload_youtube') }}" method="post" enctype="multipart/form-data">
    @csrf
