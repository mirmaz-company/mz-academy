                    ...
                    <div class="authentication-form-box-item active" data-authentication-item="1">
                        <div class="authentication-box">
                            <div class="authentication-box-inner">
                                <form id="register_main" class="authentication-form mb-20">
                                    @csrf
                                    ...
                                    <div class="input-group input-group-bg mb-20">
                                        <input type="password" class="form-control" name="password" placeholder="Enter Password" aria-label="Username">
                                    </div>
                                  
                                    <button type="button" id="add_user" class="btn main-btn main-btn-lg full-width">Register Now</button>
